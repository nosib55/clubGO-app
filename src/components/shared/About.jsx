    ...
    <div className="max-w-6xl mx-auto px-6 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <motion.div
          ...
          className="bg-base-100 shadow-md hover:shadow-xl rounded-xl p-6 transition-all"
        >
        ...
        <motion.div
          ...
          className="bg-base-100 shadow-md hover:shadow-xl rounded-xl p-6 md:col-span-2 transition-all"
        >
          <h2 className="text-2xl font-semibold mb-3 text-base-content">
            What We Offer
          </h2>
